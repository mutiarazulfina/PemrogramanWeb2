...
<html>
  ...
  <body>
      ...
      <center>
      <form method="POST" action="proses_editp.php" enctype="multipart/form-data" >
      <section class="base">
        <!-- menampung nilai id peserta yang akan di edit -->
        ...
        <div>
         ...
         <input type="text" name="instruktur" required="" value="<?php echo $data['instruktur']; ?>"/>
        </div>
        <div>
          <label>Foto</label>
