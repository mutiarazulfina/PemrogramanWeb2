  ...
  if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE instruktur SET nama = '$nama', jeniskelamin = '$jeniskelamin', ttl = '$ttl', kelas = '$kelas', alamat = 'alamat', nohp = 'nohp', email = 'email', gambar = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
      ...
      $query  = "UPDATE instruktur SET nama = '$nama', jeniskelamin = '$jeniskelamin', ttl = '$ttl', kelas = '$kelas', alamat = 'alamat', nohp = 'nohp', email = 'email'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
